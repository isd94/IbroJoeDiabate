/*var motAsaisir = prompt("Entrer votre mot:")
console.log("Le mot" + " " + motAsaisir + " " + "contient" + " " + motAsaisir.length + " " + "caractère(s)");
console.log("Il s'écrit en minuscule" + " " + motAsaisir.toLocaleLowerCase() );
console.log("Il s'écrit en majsucule" + " " + motAsaisir.toLocaleUpperCase() );*/
